                ...
                <div className="lg:col-span-1 space-y-8">
                    <div className="bg-white dark:bg-dark-surface p-6 rounded-lg border border-mercury dark:border-dark-border">
                        ...
                        <div className="space-y-3">
                            {team.map(member => (
                                <div key={member._id} className="flex items-center justify-between p-3 rounded-lg hover:bg-mercury/50 dark:hover:bg-dark-background/50">
                                    <div className="flex items-center gap-3">
                                        <img src={member.avatar || Placeholder} alt={member.user.name} className="w-10 h-10 rounded-full" />
                                        <div>
                                            <p className="font-semibold text-night dark:text-dark-text">{member.user.name}</p>
