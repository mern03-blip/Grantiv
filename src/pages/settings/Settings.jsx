...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    try {
      const savedPlan = /** @type {UserPlan} */ (
        localStorage.getItem("grantiv_user_plan")
      );
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm mb-4 sm:mb-6">
                {features.map((f) => (
                  <li key={f} className="flex items-center gap-2">
                    ...
                    <span className="text-night dark:text-dark-text">{f}</span>
                  </li>
                ))}
              </ul>
              <button
                onClick={onSelect}
                disabled={isCurrent || price === "Contact Us"}
                className={`w-full mt-auto py-2 sm:py-2.5 text-xs sm:text-sm rounded-lg font-semibold transition-colors ${
                  isCurrent
              ...
              <div className="lg:col-span-1 space-y-4 sm:space-y-6">
                ...
                <div className="bg-white dark:bg-dark-surface border border-mercury dark:border-dark-border p-4 sm:p-5 md:p-6 rounded-lg">
                  <h4 className="text-sm sm:text-base font-bold text-night dark:text-dark-text mb-2 sm:mb-3 flex items-center gap-2">
                    <ReceiptIcon className="w-4 h-4 sm:w-5 sm:h-5" /> Billing
                    History
                  </h4>
                ...
                <div className="bg-white dark:bg-dark-surface border-2 border-red-500/50 dark:border-red-500/30 p-4 sm:p-5 md:p-6 rounded-lg">
                  ...
                  <p className="text-xs sm:text-sm text-night/60 dark:text-dark-textMuted mb-3">
                    This action will downgrade your plan to &apos;Starter&apos;
              ...
              <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                  <PlanCard
                    ...
                    onSelect={() => handleSetPlan("Starter")}
