  ...
  const TabContent = () => {
    ...
    switch (activeTab) {
      case 'Eligibility':
        return (
          <div>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Eligibility Requirements</h4>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80 whitespace-pre-line">{grant.eligibility || "N/A"}</p>
          </div>
        );
      case 'Documents':
        return (
          <div>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Application Instructions</h4>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80 whitespace-pre-line">{grant.applicationInstructions || "N/A"}</p>
      ...
      case 'Contacts':
        return (
          <div>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Funder Contact</h4>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80 mb-2">Email: {grant.contactEmail || "N/A"}</p>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80">Agency: {grant.agency || "N/A"}</p>
          </div>
        );
      case 'Overview':
      default:
        return (
          <div>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Description</h4>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80 mb-3 sm:mb-4 whitespace-pre-line">{grant.description || "N/A"}</p>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Grant Activity Timeframe</h4>
            <p className="text-sm sm:text-base text-night/80 dark:text-dark-text/80 mb-3 sm:mb-4 whitespace-pre-line">{grant.grantActivityTimeframe || "N/A"}</p>
            <h4 className="text-base sm:text-lg font-bold font-heading mb-2 text-night dark:text-dark-text">Funding Objectives</h4>
        ...
        >
          ...
          <div className="flex justify-between items-start mb-3 sm:mb-4">
            <div className="flex-1 pr-2">
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold">{grant?.title ?? "N/A"}</h2>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                {/* The Icon */}
                <HeartIcon className="w-4 h-4 sm:w-5 sm:h-5" isFilled={isSaved} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6">
            <div>
              ...
              {daysRemaining >= 0 ? (
                <p
                  className={`text-xs sm:text-sm ${daysRemaining < 14
            ...
            <div>
              ...
              <p className="text-sm sm:text-base font-semibold">{grant?.location ?? "N/A"}</p>
            </div>
            <div>
              <button
            ...
            <div className="flex space-x-3 sm:space-x-4 md:space-x-6 min-w-max">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`pb-2 sm:pb-3 border-b-2 font-medium text-xs sm:text-sm whitespace-nowrap ${activeTab === tab
              ...
              >
                <div className="flex justify-between items-center mb-3 sm:mb-4">
                  <h3 className="text-base sm:text-lg md:text-xl font-bold flex items-center gap-1.5 sm:gap-2 text-night dark:text-dark-text">
                    <SparklesIcon className="w-4 h-4 sm:w-5 sm:h-5" /> AI Grant Review
                  </h3>
                  <button
                    onClick={() => setIsReviewModalOpen(false)}
