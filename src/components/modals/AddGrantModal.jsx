    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
            <motion.div
                ...
                className="bg-white dark:bg-dark-surface rounded-lg shadow-xl w-full sm:max-w-2xl max-h-[85vh] overflow-y-auto border border-mercury dark:border-dark-border"
            ...
            >
                {/* Header */}
                <div className="p-4 sm:p-6 border-b border-mercury dark:border-dark-border flex justify-between items-center">
                    <h3 className="text-base sm:text-lg font-bold font-heading text-night dark:text-dark-text">Add New Grant Project</h3>
                ...
                <div className="p-4 sm:p-6">
                    ...
                    <textarea
                        ...
                        rows={10}
                        className="w-full p-3 sm:p-4 text-sm sm:text-base border border-mercury dark:border-dark-border rounded-lg focus:ring-2 focus:ring-primary focus:outline-none dark:bg-dark-background dark:text-dark-text min-h-[180px] sm:min-h-[240px]"
                ...
                {/* Footer / Actions */}
                <div className="px-4 sm:px-6 py-3 sm:py-4 bg-mercury/30 dark:bg-dark-background/50 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 rounded-b-lg">
                    <button 
                        onClick={onClose} 
                        className="w-full sm:w-auto px-4 py-2 text-sm font-semibold bg-white dark:bg-dark-surface border border-mercury dark:border-dark-border rounded-lg hover:bg-mercury/50 dark:hover:bg-dark-background text-night dark:text-dark-text"
                        disabled={isLoading}
                    >
                        Cancel
                    </button>
                    <button 
                        ...
                        className="w-full sm:w-auto px-4 py-2 text-sm font-semibold bg-primary text-night rounded-lg hover:bg-secondary disabled:bg-mercury dark:disabled:bg-dark-border dark:text-night disabled:text-night/50 flex items-center justify-center min-w-[120px]"
                    >
