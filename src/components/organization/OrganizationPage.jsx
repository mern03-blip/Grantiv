            ...
            <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {organizations.map((org) => (
                    <div
                        ...
                        className={`group bg-white rounded-xl shadow-md p-6 cursor-pointer transform transition-all duration-300 
                                   ${loadingOrg ? 'opacity-60 cursor-not-allowed' : 'hover:-translate-y-2 hover:shadow-xl hover:border-mainColor'}
