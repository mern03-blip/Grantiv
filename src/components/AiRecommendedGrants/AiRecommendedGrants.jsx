    ...
    useEffect(() => {
        ...
        const fetchRecommendations = async () => {
            ...
            try {
                ...
                const errorMessage = "We couldn’t fetch recommendations. Kindly complete your business profile to proceed.";
...
//                 // --- Error Message ---
//                 <div className="text-center p-8 bg-red-50 dark:bg-red-900/30 rounded-lg border border-red-300 dark:border-red-700/50 text-red-700 dark:text-red-300">
//                     <p>{error.message || 'Failed to fetch recommendations.'}</p>
//                 </div>
//             ) : (
//                 // --- Data Display ---
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
