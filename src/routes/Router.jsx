...
//   const isAiAssistant = location.pathname.startsWith('/ai-assistant');
//   const animationKey = isAiAssistant ? location.pathname : location.pathname;

//   return (
//     <div
//       className={
//         !location.pathname.startsWith("/auth")
//           ? "bg-alabaster dark:bg-dark-background min-h-screen"
//           : "min-h-screen"
//       }
//     >
//       <AnimatePresence mode="wait">
...
//             {/* --- Other --- */}
//             <Route path="/accept-invite/:token" element={<InvitationPage />} />
//             <Route path="/organization-page" element={<LazyComponent path="/organization-page" />} />
//           </Routes>
//         </motion.div>
//       </AnimatePresence>
//     </div>
