  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<LazyComponent path="/organization-page"></LazyComponent>}
      />
      <Route
        path="payment"
        element={<LazyComponent path="/payment"></LazyComponent>}
      />
    </Routes>
  );
};
